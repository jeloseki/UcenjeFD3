...
// ovdje mopže doći prompt s parseInt ili Number - ULAZ
const a = 2, b = 3 // deklariranje svije varijable u jednoj liniji
...
// načini uvećanja varijable za 1
rez = rez + 1 // 11
rez += 1 // 12
...
// &&, || i ! -> U JS se ne smije koristiti & na boolean, rezerviran je za korištenje 
...
// operator spanjanja - nadoljepljivanja (concatenation)
// +
...
const niz = [2, 1] // konstanta koja se ne može mjenjati
...
const{prezime, ...meniBitno} = polaznik// prezime je ovdje otpadak - ne treba mi, ali mi je način da iz polaznika maknem prezime

console.log(meniBitno) // imam ime i edukacija, bez prezimena

// bullish calescing operator
