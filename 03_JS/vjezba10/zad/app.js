...
document.getElementById('izvedi').addEventListener('click', () => {
  ...
  switch (zadatak) {
    case '1':
      ...
      // moj kod ce ici u smjeru da dokazem kako nije prim
      // moj dokaz je taj da kada nadjem prvi broj koji je cjelobrojno djeljiv (ostatak 0), prekidam izvodjenje
    ...
    case '4':
      ...
      let p = ''
    // prvo cistim razmake i svodim sve na mala slova
